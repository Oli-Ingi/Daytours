...
INSERT INTO Tours(
	Name,Description,Duration,Rating,NumberOfRatings,Price,Destination,Departure,Type,HotelPickup,Guide1)
	VALUES(
	'Silfra scuba diving','We dive into Silfra with scuba gear
It is gonna be awesome! ..  bring your own frog feet',7,4.2,45,17000,'Silfra','Reykjavik','Adventure',1,'Siggi Steinn');
